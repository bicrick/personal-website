...
function PrivacyPolicy() {
  return (
    <div className="container">
      ...
      <p style={{ fontSize: '14px', color: '#666', marginBottom: '30px' }}>Revised Jun. 3, 2019</p>

      <p>
        This privacy policy has been compiled to better serve those who are concerned with how their 'Personally Identifiable Information' (PII) is being used online. PII, as described in US privacy law and information security, is information that can be used on its own or with other information to identify, contact, or locate a single person, or to identify an individual in context. Please read our privacy policy carefully to get a clear understanding of how we collect, use, protect or otherwise handle your PII.
      </p>

      <h2>What personal information do we collect from the people that visit our website or app(s)?</h2>
      <p>We may request the names and/or email addresses of our users.</p>

      <h2>When do we collect information?</h2>
      <p>The aforementioned information is collected from you when you fill out a form or enter information on our website or app(s).</p>

      <h2>How is your information used?</h2>
      <p>We may use the aforementioned information to ask for feedback, ratings, and/or reviews of services or products, to answer a question or provide clarification about services or products, or to otherwise respond to user requests.</p>

      <h2>How do we protect your information?</h2>
      <p>We conduct regular vulnerability scans. We never ask for sensitive information like credit card numbers or social security numbers. We use an SSL certificate to secure user connections to our website.</p>

      <h2>Do we use cookies?</h2>
      <p>We do not use cookies at this time.</p>

      <h2>Third-party disclosure</h2>
      <p>We do not sell, trade, or otherwise transfer to outside parties your PII. This does not include website hosting partners and other parties who assist us in operating our website or serving our users, so long as those parties agree to keep this information confidential. We may also release information when it's release is appropriate to comply with the law, enforce our site policies, or protect ours or others' rights, property or safety.</p>

      <h2>Third-party links</h2>
      <p>Third-party sites linked on our website or app(s) have separate and independent privacy policies. We have no responsibility or liability for the content and activities of these linked sites. Nonetheless, we seek to protect the integrity of our site and welcome any feedback about these sites.</p>
      ...
      <footer>
        <p><Link to="/">← Back to Home</Link> • © 2025 Patrick Brown</p>
      </footer>
    </div>
  );
}
